    ...
    <section className="max-w-7xl mx-auto px-6 pb-24">
      ...
      >
        ...
        <div className="relative z-10 flex items-center justify-between border-b border-zinc-800 px-6 py-3 bg-zinc-950/60 backdrop-blur-sm">
          <div className="flex items-center gap-3">
            ...
            <span className="font-mono text-xs text-zinc-500 ml-3">
              ...
              <span className="text-zinc-400">{t("review")}</span>
            </span>
          </div>
          <div className="hidden sm:flex items-center gap-2">
            <span className="w-1.5 h-1.5 rounded-full bg-amber-400 animate-pulse" />
            <span className="font-mono text-xs text-zinc-600">{t("live")}</span>
          </div>
        </div>
        ...
        <div className="relative z-10 flex items-center justify-between border-t border-zinc-800/50 px-6 py-2 bg-zinc-950/40">
          <span className="font-mono text-xs text-zinc-700">{t("platform")}</span>
          <div className="flex items-center gap-4">
            <span className="font-mono text-xs text-zinc-700">{t("processing")}: <span className="text-zinc-500">—</span></span>
            <span className="font-mono text-xs text-zinc-700">{t("anomalies")}: <span className="text-zinc-500">—</span></span>
          </div>
        </div>
      </motion.div>
    </section>
